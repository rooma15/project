...
$auctions = $mysqli->query("SELECT * FROM participants");
$arr = array();
$i = 0;
while($result = $auctions->fetch_assoc())
{
    $result['src'] = "img/auctions/" . $result['name'] . "_" . $result['surname'] . ".png";
